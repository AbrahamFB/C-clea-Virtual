                        ...
                        <div class="panel-body">
                            ...
                            <div class="mt-3">
                                ...
                                while ($fila = mysqli_fetch_array($comentar)) {
                                    $propiedad = $conexion5->propiedadesCuenta($fila[3]);

                                ?>
                                    <div class="media border p-3">
                                        <div class="media-body">
                                            <h4><?php echo $propiedad[0]; ?> <small><i>Comentado on February 19, 2016</i></small></h4>
                                            <?php
                                            echo "<p>" . $fila[2] . "</p>";
                                            ?>
                                        </div>
                                        <img src="img/extras/user.png" alt="" class="ml-3 mt-3 rounded-circle" style="width:60px;">
                                    </div>
                                <?php
                                }
                                ?>
